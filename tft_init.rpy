...
# Sounds:
    ...
    $ vzveiteskostrami = "mods/TFT/image/sound/music/vzveiteskostrami.mp3"
...
# Pictures:
    ...
    image d4_dvswim_tft = "mods/TFT/image/cg/d4_dvswim_tft.jpg"
    image d4_dv_stage_1_ll = "mods/TFT/image/cg/d4_dv_stage_1_ll.jpg"
    image d4_dv_stage_2_ll = "mods/TFT/image/cg/d4_dv_stage_2_ll.jpg"
    image d4_dv_stage_3_ll = "mods/TFT/image/cg/d4_dv_stage_3_ll.jpg"
...
# Backgrounds:
    ...
    image dct_ext_hangar_sunset = "mods/TFT/image/bg/dct_ext_hangar_sunset.jpg"
    image int_house_of_nuv_day = "mods/TFT/image/bg/int_house_of_nuv_day.jpg"
    ...
    image dom = "mods/TFT/image/bg/san_int_house_male_day.jpg"
    ...
    image domeven = "mods/TFT/image/bg/san_int_house_male_evening.png"
    image muznight3 = "mods/TFT/image/bg/muznight3.jpg"
    image domnight = "mods/TFT/image/bg/san_int_house_male_night.jpg"
    ...
    image ext_warehouse_sunset_7dl = "mods/TFT/image/bg/ext_warehouse_sunset_7dl.jpg"
    ...
    image ext_bush_day_7dl = "mods/TFT/image/bg/ext_bush_day_7dl.jpg"
    image ext_bush_sunset_7dl = "mods/TFT/image/bg/ext_bush_sunset_7dl.jpg"
    image ext_backroad_day_7dl = "mods/TFT/image/bg/ext_backroad_day_7dl.jpg"
    image ext_backroad_sunset_7dl = "mods/TFT/image/bg/ext_backroad_sunset_7dl.jpg"
    image ext_backdoor_day_7dl = "mods/TFT/image/bg/ext_backdoor_day_7dl.jpg"
    image ext_backdoor_sunset_7dl = "mods/TFT/image/bg/ext_backdoor_sunset_7dl.jpg"
    image ext_forest_road_day_ll = "mods/TFT/image/bg/ext_forest_road_day_ll.jpg"
    image ext_forest_road_night_ll = "mods/TFT/image/bg/ext_forest_road_night_ll.jpg"
    image ext_forest_road_rain_ll = "mods/TFT/image/bg/ext_forest_road_rain_ll.jpg"
    image ext_village_back_day_ll = "mods/TFT/image/bg/ext_village_back_day_ll.jpg"
    image ext_village_day_ll = "mods/TFT/image/bg/ext_village_day_ll.jpg"
    image ext_village_rain_ll = "mods/TFT/image/bg/ext_village_rain_ll.jpg"
    image ext_washstand_night_7dl = "mods/TFT/image/bg/ext_washstand_night_7dl.jpg"
    ...
    image ext_warehouse_rain_day_7dl = "mods/TFT/image/bg/ext_warehouse_rain_day_7dl.jpg"
    image ext_musclub_rain_7dl = "mods/TFT/image/bg/ext_musclub_rain_7dl.jpg"
...
# image/sprites:
    ...
    image dv smile pioneerskirt flt = getSprite("mods/TFT/image/sprites/dv/normal/swim/dv_smile_pioneerskirt.png")
    image dv smile pioneershirt flt = getSprite("mods/TFT/image/sprites/dv/normal/swim/dv_smile_pioneershirt.png")
    image dv smile swimhair flt = getSprite("mods/TFT/image/sprites/dv/normal/swim/dv_smile_swimhair.png")
    image dv grin swimhair flt = getSprite("mods/TFT/image/sprites/dv/normal/swim/dv_grin_swimhair.png")
    ...
    image dv surprise pioneer flt = getSprite("mods/TFT/image/sprites/dv/normal/pioneer/dv_surprise_pioneer.png")
    ...
    image dv guilty pioneer flt = getSprite("mods/TFT/image/sprites/dv/normal/pioneer/dv_pioneer_guilty_flt.png")
    image dv sad pioneer flt = getSprite("mods/TFT/image/sprites/dv/normal/pioneer/dv_pioneer_sad_flt.png")
    ...
    image dv smile pioneer2 flt = getSprite("mods/TFT/image/sprites/dv/normal/pioneer2/dv_smile_pioneer2.png")
    ...
    image mi_shy_wet_rain = getSprite("mods/TFT/image/sprites/mi/wet/mi_shy_wet_rain.png")
    image mi_smile_wet_rain = getSprite("mods/TFT/image/sprites/mi/wet/mi_smile_wet_rain.png")
    image mi_surprise_wet_rain = getSprite("mods/TFT/image/sprites/mi/wet/mi_surprise_wet_rain.png")
