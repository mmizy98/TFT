label tft_1:
    ...
    dns "Конечно умею! Если б не умел не пошел бы."
    ...
    play sound sfx_sfx_unzip_sleepbag

    "Шарясь по рюкзаку рукой почти сразу нащупал телефон, лежащий в боковом кармане вместе с наушниками."
    ...
    th "Судя по всему в это время я и переходил ты злополучную дорогу."
