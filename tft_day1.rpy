label tft_1:
    ...
    "Противники отбивают его к нам."
    "Алиса с Ульянкой не успели, а я был далеко."
    ...
    "Я успеваю среагировать и отбиваю. {w}Алиса накидывает Ульяне, та ударяет и мяч ложится за сеткой."
    "Счёт {b}4:1."
    ...
    "Следующие два часа мы провели за игрой."
    ...
    "Мы выиграли, но противники не унывали."
    ...
    "Ребята, против которых мы играли разошлись пошли по своим делам."

    window hide
    show ars_smile with dissolve
    window show

    "А я и Арсений пошли в домик."
