label tft_day2:
    ...
    ars "Нет. {w}Сегодня четвёртый четверг месяца, а это значит что в лагере санитарный день, и после завтрака все пионеры будут убирать территорию лагеря. {w}Не думаю что ты больше предпочёл бы это."
    dns "Ладно, убедил."
    window hide
    ...
    show dv normal pioneer with dissolve2
    window show
